...
--
-- Host: localhost    Database: db_opencart
-- ------------------------------------------------------
...
(1,'Default','',1,'2024-12-02 03:56:37','2024-12-02 03:56:37');
...
CREATE TABLE `oc_customer` (
  ...
  `commenter` tinyint(1) DEFAULT NULL,
...
(24,'mail_review','Sends mail to store owner that a new review has been submitted.','catalog/model/catalog/review.addReview/after','mail/review',1,1),
(25,'mail_subscription','Sends mail to store owner that a new subscription has been created.','catalog/model/checkout/subscription.addSubscription/after','mail/subscription',1,1),
(26,'statistics_review_add','Updates review statistics when a new review is added.','catalog/model/catalog/review.addReview/after','event/statistics.addReview',1,1),
(27,'statistics_return_add','Updates return statistics when a new return is added.','catalog/model/account/returns.addReturn/after','event/statistics.addReturn',1,1),
(28,'statistics_return_delete','Updates return statistics when a return is deleted.','admin/model/sale/returns.deleteReturn/after','event/statistics.deleteReturn',1,1),
(29,'statistics_order_history','Updates order status statistics when a order has been updated.','catalog/model/checkout/order.addHistory/before','event/statistics.addHistory',1,1),
(30,'admin_currency_add','Updates currencies when a new currency is added.','admin/model/localisation/currency.addCurrency/after','event/currency',1,1),
(31,'admin_currency_edit','Updates currencies when a currency is edited.','admin/model/localisation/currency.editCurrency/after','event/currency',1,1),
(32,'admin_currency_setting','Updates currencies when settings are saved.','admin/model/setting/setting.editSetting/after','event/currency',1,1),
(33,'admin_mail_gdpr','Sends approval or denial mail to customer who requested GDPR data export or deletion.','admin/model/customer/gdpr.editStatus/after','mail/gdpr',1,1),
(34,'admin_mail_affiliate_approve','Sends mail to the affiliate when their account is approved.','admin/model/customer/customer_approval.approveAffiliate/after','mail/affiliate.approve',1,1),
(35,'admin_mail_affiliate_deny','Sends mail to the affiliate when their account is denied.','admin/model/customer/customer_approval.denyAffiliate/after','mail/affiliate.deny',1,1),
(36,'admin_mail_customer_approve','Sends mail to the customer when their account is approved.','admin/model/customer/customer_approval.approveCustomer/after','mail/customer.approve',1,1),
(37,'admin_mail_customer_deny','Sends mail to the customer when their account is denied.','admin/model/customer/customer_approval.denyCustomer/after','mail/customer.deny',1,1),
(38,'admin_mail_customer_transaction','Sends mail to the customer when their transaction balance is updated.','admin/model/customer/customer.addTransaction/after','mail/transaction',1,1),
(39,'admin_mail_reward','Sends mail to the customer when their reward balance is updated.','admin/model/customer/customer.addReward/after','mail/reward',1,1),
(40,'admin_mail_return','Sends mail to customer when their return status is changed.','admin/model/sale/returns.addHistory/after','mail/returns',1,1),
(41,'admin_mail_user_forgotten','Sends mail to users who have forgotten their password.','admin/model/user/user.editCode/after','mail/forgotten',1,1),
(42,'admin_mail_user_authorize','Sends mail login code to users email to authorize login from a new device.','admin/controller/common/authorize.send/after','mail/authorize',1,1),
(43,'admin_mail_user_authorize_reset','Sends reset link to user who`s account is locked out after 3 wrong authorize code login attempts.','admin/model/user/user.editCode/after','mail/authorize.reset',1,1);
...
CREATE TABLE `oc_extension_path` (
  ...
  KEY `path` (`path`)
) ENGINE=InnoDB AUTO_INCREMENT=396 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oc_return` (
  ...
  `return_action_id` int(11) DEFAULT NULL,
...
('18a18065d6527e5e453a98d248','{\"currency\":\"USD\"}','2024-12-03 03:59:31'),
('b20196d78ab9e4b0e498586149','{\"user_id\":\"1\",\"user_token\":\"2e605cc924da876e91bd37e4a1bdf213\",\"success\":\"Success: Admin directory has been moved!\"}','2024-12-03 03:59:04'),
('be5870c7865687b19ddffb46e4','{\"login_token\":\"b058e46b912f144c2704baf928375515\"}','2024-12-03 03:59:27'),
('d916e6c874f895865674d0c067','{\"currency\":\"USD\"}','2024-12-03 04:01:15');
...
(14,0,'config','config_language_catalog','en-gb',0),
...
(22,0,'config','config_article_description_length','600',0),
(23,0,'config','config_pagination','10',0),
(24,0,'config','config_pagination_admin','10',0),
(25,0,'config','config_autocomplete_limit','5',0),
...
(73,0,'config','config_image_default_width','300',0),
(74,0,'config','config_image_default_height','300',0),
(75,0,'config','config_image_thumb_width','500',0),
(76,0,'config','config_image_thumb_height','500',0),
(77,0,'config','config_image_popup_width','800',0),
(78,0,'config','config_image_popup_height','800',0),
(79,0,'config','config_image_category_width','300',0),
(80,0,'config','config_image_category_height','300',0),
(81,0,'config','config_image_article_width','1140',0),
(82,0,'config','config_image_article_height','380',0),
(83,0,'config','config_image_topic_width','1140',0),
(84,0,'config','config_image_topic_height','380',0),
(85,0,'config','config_image_product_width','250',0),
(86,0,'config','config_image_product_height','250',0),
(87,0,'config','config_image_additional_width','74',0),
(88,0,'config','config_image_additional_height','74',0),
(89,0,'config','config_image_related_width','250',0),
(90,0,'config','config_image_related_height','250',0),
(91,0,'config','config_image_compare_width','90',0),
(92,0,'config','config_image_compare_height','90',0),
(93,0,'config','config_image_wishlist_width','47',0),
(94,0,'config','config_image_wishlist_height','47',0),
(95,0,'config','config_image_cart_height','47',0),
(96,0,'config','config_image_cart_width','47',0),
(97,0,'config','config_image_location_height','268',0),
(98,0,'config','config_image_location_width','268',0),
(99,0,'config','config_open','',0),
(100,0,'config','config_image','',0),
(101,0,'config','config_fax','',0),
(102,0,'config','config_telephone','123456789',0),
(103,0,'config','config_email','admin@gmail.com',0),
(104,0,'config','config_geocode','',0),
(105,0,'config','config_owner','Your Name',0),
(106,0,'config','config_address','Address 1',0),
(107,0,'config','config_name','Your Store',0),
(108,0,'config','config_seo_url','0',0),
(109,0,'config','config_file_max_size','20',0),
(110,0,'config','config_file_ext_allowed','zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\nwebp\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nmp4\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc',0),
(111,0,'config','config_file_mime_allowed','text/plain\r\nimage/png\r\nimage/webp\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\napplication/x-zip\r\napplication/x-zip-compressed\r\napplication/rar\r\napplication/x-rar\r\napplication/x-rar-compressed\r\napplication/octet-stream\r\naudio/mpeg\r\nvideo/mp4\r\nvideo/quicktime\r\napplication/pdf',0),
(112,0,'config','config_maintenance','0',0),
(113,0,'config','config_encryption','',0),
(114,0,'config','config_compression','0',0),
(115,0,'config','config_error_display','1',0),
(116,0,'config','config_error_log','1',0),
(117,0,'config','config_error_filename','error.log',0),
(118,0,'config','config_mail_engine','',0),
(119,0,'config','config_mail_parameter','',0),
(120,0,'config','config_mail_smtp_hostname','',0),
(121,0,'config','config_mail_smtp_username','',0),
(122,0,'config','config_mail_smtp_password','',0),
(123,0,'config','config_mail_smtp_port','25',0),
(124,0,'config','config_mail_smtp_timeout','5',0),
(125,0,'config','config_mail_alert_email','',0),
(126,0,'config','config_mail_alert','[\"order\"]',1),
(127,0,'config','config_captcha','basic',0),
(128,0,'config','config_captcha_page','[\"review\",\"return\",\"contact\"]',1),
(129,0,'config','config_login_attempts','5',0),
...
CREATE TABLE `oc_subscription` (
  ...
  `trial_cycle` smallint(6) DEFAULT NULL,
  `trial_duration` smallint(6) DEFAULT NULL,
  `trial_remaining` smallint(6) DEFAULT NULL,
  `trial_status` tinyint(1) DEFAULT NULL,
  `price` decimal(10,4) DEFAULT NULL,
  `frequency` enum('day','week','semi_month','month','year') DEFAULT NULL,
  `cycle` smallint(6) DEFAULT NULL,
...
CREATE TABLE `oc_subscription_plan` (
  ...
  `trial_frequency` enum('day','week','semi_month','month','year') DEFAULT NULL,
  `trial_duration` int(10) DEFAULT NULL,
  `trial_cycle` int(10) DEFAULT NULL,
  `trial_status` tinyint(4) DEFAULT NULL,
  `frequency` enum('day','week','semi_month','month','year') DEFAULT NULL,
...
(1,1,'admin','$2y$10$z.9R96b52tTFSLEzI0xSP.g47C1Nt66CHBCKd8zyuWd0IXgxBBf5S','John','Doe','admin@gmail.com','','','114.10.76.185',1,'2024-12-02 03:56:37');
...
(1,1,'114.10.79.185','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:133.0) Gecko/20100101 Firefox/133.0','2024-12-02 03:58:13'),
(2,1,'114.10.76.185','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:133.0) Gecko/20100101 Firefox/133.0','2024-12-02 03:59:07');
...
CREATE TABLE `oc_zone` (
  ...
  `status` tinyint(1) DEFAULT 1,
  PRIMARY KEY (`zone_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4446 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-02  6:55:08
